...
<body>
	...
	<div id="holecontains">
		<div class="fst">
			...
			<p>Our website provides a variety of diet plans to help you
				achieve your fitness goals. Whether you're looking to lose weight,
				gain muscle, or simply maintain a healthy lifestyle, we have a plan
				that's right for you.</p>
			<div class="btn">
				<a href="./pages/diet2.html"><button>
