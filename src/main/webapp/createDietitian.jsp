...
<form id="form"  action="DietitianServlet" method="post">
      ...
      <div class="inputBox">
        <input id="docname" type="text" name="DietitianName" required="required" />
        <span>Doctor Name</span>
      </div>
      <div class="inputBox">
        <input id="Special" type="text" name="DietitianQualification" required="required" />
        <span>specialist</span>
      </div>
      <div class="inputBox">
        <input id="experience" type="text" name="DietitianExperience" required="required" />
